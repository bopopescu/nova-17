...
class ComputeManager(manager.Manager):
    ...
    def init_host(self):
        ...
        try:
            # NOTE(rgerganov): we don't have 1:1 relation between n-cpu
            # and hypervisors in the VMware case which breaks the
            # assumptions being made for evacuating instances
            if not driver.compute_driver_matches('VMwareVCDriver'):
                # checking that instance was not already evacuated to other
                # host
    ...
    def get_vnc_console(self, context, console_type, instance):
        ...
        try:
            ...
            if connect_info.get('password'):
                access_url += "&password=%s" % connect_info['password']
