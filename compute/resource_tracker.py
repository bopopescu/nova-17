...
resource_tracker_opts = [
    ...
    cfg.BoolOpt('use_hypervisor_stats',
                default=False,
                help='Use the stats reported from the hypervisor instead '
                     'calculating them from the running instances')
]
...
class ResourceTracker(object):
    ...
    def update_available_resource(self, context):
        ...
        if not CONF.use_hypervisor_stats:
            ...
            resources['free_ram_mb'] = free_ram_mb
            resources['free_disk_gb'] = free_disk_gb
