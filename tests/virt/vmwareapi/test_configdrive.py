...
class ConfigDriveTestCase(test.NoDBTestCase):
    ...
    @mock.patch.object(vim_util, 'get_inventory_path')
    def test_create_vm_with_config_drive_verify_method_invocation(
            self, mock_inv_path):
    ...
    @mock.patch.object(vim_util, 'get_inventory_path')
    def test_create_vm_without_config_drive(self, mock_inv_path):
    ...
    @mock.patch.object(vim_util, 'get_inventory_path')
    def test_create_vm_with_config_drive(self, mock_inv_path):
        self.test_instance.config_drive = 'True'
        self._spawn_vm()
