...
class VMwareVolumeOpsTestCase(test.NoDBTestCase):
    ...
    def setUp(self):
        ...
        self._image_id = '155d900f-4e14-4e4c-a73d-069cbf4541e6'
        self.instance = {
            'name': 'fake_name',
            'uuid': 'fake_uuid',
            'vcpus': 1,
    ...
    def _test_attach_volume_vmdk(self, adapter_type=None):
        ...
        vmdk_info = vm_util.VmdkInfo('fake-path', default_adapter_type,
                                     ...
                                     device)
        adapter_type = adapter_type or vmdk_info.adapter_type
        ...
        with contextlib.nested(
            ...
            self._volumeops.attach_volume(connection_info, self.instance,
                                          adapter_type)
    ...
    def _test_attach_volume_iscsi(self, adapter_type=None):
        ...
        with contextlib.nested(
            ...
            mock.patch.object(self._volumeops, 'attach_disk_to_vm')
              ...
              get_vmdk_info, attach_disk_to_vm):
            self._volumeops.attach_volume(connection_info, self.instance,
                                          adapter_type)
            ...
            attach_disk_to_vm.assert_called_once_with(vm_ref,
                self.instance, adapter_type, 'rdmp',
    ...
    def test_attach_volume_vmdk(self):
        ...
        # IDE cannot be hot plugged
        self.instance['vm_state'] = vm_states.STOPPED
        self._test_attach_volume_vmdk(constants.ADAPTER_TYPE_IDE)
