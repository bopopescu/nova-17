...
spbm_opts = [
    ...
    cfg.StrOpt('pbm_wsdl_location',
               help='Optional PBM service WSDL file location URL '
                    'e.g. file:///opt/SDK/spbm/wsdl/pbmService.wsdl'),
    cfg.StrOpt('pbm_default_policy',
               help='The PBM default policy. If pbm_enabled is set and '
...
class VMwareESXDriver(driver.ComputeDriver):
    ...
    def _do_deprecation_warning(self):
        LOG.warn(_('The VMware ESX driver is now deprecated and has been '
...
class VMwareVCDriver(driver.ComputeDriver):
    ...
    def _validate_configuration(self):
        ...
        if CONF.vmware.pbm_enabled:
            ...
            if CONF.vmware.datastore_regex:
                LOG.warn(_("datastore_regex is ignored when PBM is enabled"))
                self._datastore_regex = None
    ...
    def live_migration(self, ctxt, instance_ref, dest,
        ...
        self._vmops.live_migration(ctxt, instance_ref, dest,
    ...
    def rollback_live_migration_at_destination(self, ctxt, instance_ref,
        ...
        self.destroy(ctxt, instance_ref, network_info, block_device_info)
    ...
    def attach_volume(self, context, connection_info, instance, mountpoint,
        ...
        return _volumeops.attach_volume(connection_info, instance)

    def detach_volume(self, connection_info, instance, mountpoint,
                      encryption=None):
        """Detach volume storage to VM instance."""
        _volumeops = self._get_volumeops_for_compute_node(instance['node'])
        return _volumeops.detach_volume(connection_info, instance)
    ...
    def instance_exists(self, instance_id):
        ...
        return self._vmops.instance_exists(instance_id)
    ...
    def get_host_uptime(self, host):
        ...
        uptime = self._vmops.get_host_uptime()
...
class VMwareAPISession(api.VMwareAPISession):
    ...
    def __init__(self, **kwargs):
        host_ip = kwargs.get('host_ip', CONF.vmware.host_ip)
        host_port = kwargs.get('host_port', CONF.vmware.host_port)
        username = kwargs.get('username', CONF.vmware.host_username)
        password = kwargs.get('password', CONF.vmware.host_password)
        retry_count = kwargs.get('retry_count', CONF.vmware.api_retry_count)
